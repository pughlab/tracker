...
public class StudyAboutExtractorTest extends AbstractShiroTest {

	private class TraceRestlet extends Restlet {
		// Does snothing, but prevents warning shouts
	}

	private StudyAboutExtractor extractor;
	...
	public void initialize() {
		...
		extractor = new StudyAboutExtractor();
	...
	public void testBasicExtraction() {
		...
		StudyAboutResponse study = RequestAttributes.getRequestStudyAbout(request);
		assertNotNull(study);
	}
	...
	@Ignore
	public void testPublic() throws ResourceException {
