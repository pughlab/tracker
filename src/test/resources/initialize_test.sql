...
INSERT INTO "STUDIES" ("ID", "NAME", "DESCRIPTION", "OPTIONS", "ABOUT") VALUES (1, 'DEMO', 'A demo clinical genomics study', '{"stateLabels":{"pending":"label1","returned":"label2"}}', '#### Markdown-based description');
