...
INSERT INTO "STUDIES" ("ID", "NAME", "DESCRIPTION", "OPTIONS", "ABOUT") VALUES (1, 'DEMO', 'A demo clinical genomics study', '{"dateFormat":"DD-MMM-YYYY","stateLabels":{"pending":"label1","returned":"label2"},"stateRules":[{"state":"pending","attribute":"returnRequested","value":"true"}]}', '#### Markdown-based description');
