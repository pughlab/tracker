-- =============================================================================================
-- Delete permissions due to stupid integrity ordering
...
INSERT INTO "STUDIES" ("ID", "NAME", "DESCRIPTION", "OPTIONS", "ABOUT") VALUES (1, 'DEMO', 'A demo clinical genomics study', '{"dateFormat":"D-MMM-YYYY","stateLabels":{"pending":"label1","returned":"label2"},"stateRules":[{"state":"pending","attribute":"returnRequested","value":"true"}]}', '#### Markdown-based description');
...
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID", "STATE") VALUES (1, UUID(UUID()), 1, 1, 'pending');
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID", "STATE") VALUES (2, UUID(UUID()), 2, 1, 'pending');
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (3, UUID(UUID()), 3, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID", "STATE") VALUES (4, UUID(UUID()), 4, 1, 'pending');
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (5, UUID(UUID()), 5, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (6, UUID(UUID()), 6, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (7, UUID(UUID()), 7, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (8, UUID(UUID()), 8, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (9, UUID(UUID()), 9, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (10, UUID(UUID()), 10, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (11, UUID(UUID()), 11, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (12, UUID(UUID()), 12, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (13, UUID(UUID()), 13, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (14, UUID(UUID()), 14, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (15, UUID(UUID()), 15, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (16, UUID(UUID()), 16, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (17, UUID(UUID()), 17, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (18, UUID(UUID()), 18, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (19, UUID(UUID()), 19, 1);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (20, UUID(UUID()), 20, 1);

INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID", "STATE") VALUES (21, UUID(UUID()), 21, 2, 'pending');
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID", "STATE") VALUES (22, UUID(UUID()), 22, 2, 'active');
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID", "STATE") VALUES (23, UUID(UUID()), 23, 2, 'pending');
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID", "STATE") VALUES (24, UUID(UUID()), 24, 2, 'pending');
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID", "STATE") VALUES (25, UUID(UUID()), 25, 2, 'pending');
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (26, UUID(UUID()), 26, 2);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (27, UUID(UUID()), 27, 2);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (28, UUID(UUID()), 28, 2);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (29, UUID(UUID()), 29, 2);
INSERT INTO "CASES" ("ID", "GUID", "ORDER", "STUDY_ID") VALUES (30, UUID(UUID()), 30, 2);
...
INSERT INTO "CASE_ATTRIBUTE_STRINGS" ("CASE_ID", "ATTRIBUTE_ID", "VALUE") VALUES (5, 17, U&'BRAF >> V600E (73%)\000APIK3CA >> E545G (31%)');
...
INSERT INTO "CASE_ATTRIBUTE_BOOLEANS" ("CASE_ID", "ATTRIBUTE_ID", "VALUE") VALUES (1, 22, 1);
INSERT INTO "CASE_ATTRIBUTE_BOOLEANS" ("CASE_ID", "ATTRIBUTE_ID", "VALUE") VALUES (2, 22, 1);
INSERT INTO "CASE_ATTRIBUTE_BOOLEANS" ("CASE_ID", "ATTRIBUTE_ID", "VALUE") VALUES (3, 22, 0);
INSERT INTO "CASE_ATTRIBUTE_BOOLEANS" ("CASE_ID", "ATTRIBUTE_ID", "VALUE") VALUES (4, 22, 1);
INSERT INTO "CASE_ATTRIBUTE_BOOLEANS" ("CASE_ID", "ATTRIBUTE_ID", "VALUE") VALUES (5, 22, 0);
...
INSERT INTO "USERS" ("ID", "USERNAME", "HASH", "GIVEN_NAME", "FAMILY_NAME") VALUES (4, 'stuart', '$2a$10$axuMX9WrGc4j6q0ifC06K.fv1L7wrfKH5RTrHycp7FqjKJxrKTvde', 'Stuart', 'Watt');
